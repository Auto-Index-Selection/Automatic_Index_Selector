...
CREATE INDEX IF NOT EXISTS ais_tpcc_std_stock_s_w_id_s_quantity ON stock (s_w_id, s_quantity);
CREATE INDEX IF NOT EXISTS ais_tpcc_std_warehouse_w_id ON warehouse (w_id);
