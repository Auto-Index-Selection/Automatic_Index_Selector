...
CREATE INDEX IF NOT EXISTS ais_tpcc_std_new_orders_no_o_id_no_d_id ON new_orders (no_o_id, no_d_id);
CREATE INDEX IF NOT EXISTS ais_tpcc_std_order_line_ol_o_id_ol_d_id ON order_line (ol_o_id, ol_d_id);
