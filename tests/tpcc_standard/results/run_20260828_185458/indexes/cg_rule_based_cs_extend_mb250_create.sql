CREATE INDEX IF NOT EXISTS ais_tpcc_std_customer_c_id_c_d_id ON customer (c_id, c_d_id);
...
CREATE INDEX IF NOT EXISTS ais_tpcc_std_order_line_ol_d_id ON order_line (ol_d_id);
